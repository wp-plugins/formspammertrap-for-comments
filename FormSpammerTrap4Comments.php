...
<?php
    ...
    {        
        ...
        add_settings_field(
            ...
            array( $this, 'title_reply_callback' ), // Callback, determines function that builds the input tag
            'fst4c-setting-admin', 
            'setting_section_id', // Section           
			array('fieldtype' => 'checkbox', 'fieldsize' => null, 'fieldmax' => null )
        );      
        ...
        add_settings_field(
            ...
            array( $this, 'title_reply_to_callback' ), // Callback, determines function that builds the input tag
            'fst4c-setting-admin', 
            'setting_section_id', // Section           
			array('fieldtype' => 'checkbox', 'fieldsize' => null, 'fieldmax' => null )
        );      
        ...
        add_settings_field(
            ...
            array( $this, 'cancel_reply_link_callback' ), // Callback, determines function that builds the input tag
            'fst4c-setting-admin', 
            'setting_section_id', // Section           
			array('fieldtype' => 'checkbox', 'fieldsize' => null, 'fieldmax' => null )
        );      
        ...
        add_settings_field(
            ...
            array( $this, 'submit_label_callback' ), // Callback, determines function that builds the input tag
            'fst4c-setting-admin', 
            'setting_section_id', // Section           
			array('fieldtype' => 'checkbox', 'fieldsize' => null, 'fieldmax' => null )
        );      
    ...
    public function print_section_info()
    {
		...
		print '<p><em>No HTML or code allowed in settings fields; it will be stripped out, leaving only plain text.</em> Note that some settings depend on other things; see the notes to the right of each setting.</p>';
    }
    ...
    {
       printf(
            '<input type="text" type="hidden" id="the_version" name="fst4c_options[the_version]" value="1.03 (20-Feb-2015)" readonly="readonly" width="5" maxlength="5" />',
...
// ---------------------------------------------------------------------------- 
// ---------------------------------------------------------------------------- 
// uses the code from the plugin: https://wordpress.org/plugins/comment-form-inline-errors/
// 		which handles form errors (missing required fields, etc) 
//		plus checks WordPress and PHP versions
//		Code used via that plugin's GPL2, so is lawfully included
